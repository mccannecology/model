...
require(doSNOW)
require(parallel)
cl <- makeCluster(3,"PSOCK") # not sure if I should set this to 4
...
foreach (i=1:totalsimuls) %dopar% { # loop through all of your simulations - User needs to specify the max # of simulations (rows of parameters) in .csv
  #require(R.utils) # package for sourceDirectory()
