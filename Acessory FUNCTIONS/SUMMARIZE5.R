...
FP_plot_MOVE <- FP_plot_MOVE + ylab(expression(paste("Annual avg. FP cover excl. 1st 3 yr")))
...
SAV_plot_MOVE <- SAV_plot_MOVE + ylab(expression(paste("Annual avg. SAV cover excl. 1st 3 yr")))
...
ggsave(file="output16 - FP&SAV - with_wind - with_MOVE - constant NtoP.pdf",combined_plot_MOVE, height=11,width=8)
...
FP_plotnoMOVE <- FP_plotnoMOVE + ylab(expression(paste("Annual avg. FP cover excl. 1st 3 yr")))
...
SAV_plotnoMOVE <- SAV_plotnoMOVE + ylab(expression(paste("Annual avg. SAV cover excl. 1st 3 yr")))
...
ggsave(file="output16 - FP&SAV - with_wind - without_MOVE - constant NtoP.pdf",combined_plot_noMOVE, height=11,width=8)
...
FP_plot_MOVE_2 <- FP_plot_MOVE_2 + ylab(expression(paste("Annual avg. FP cover excl. 1st 3 yr")))
...
FP_plot_MOVE_2 <- FP_plot_MOVE_2 + ggtitle("With MOVE()")
FP_plot_MOVE_2
ggsave(file="output16 - FP&SAV - with_wind - with_MOVE - constant NtoP - FP only.pdf",FP_plot_MOVE_2, height=11,width=8)
...
SAV_plot_MOVE_2 <- SAV_plot_MOVE_2 + ylab(expression(paste("Annual avg. SAV cover excl. 1st 3 yr")))
...
SAV_plot_MOVE_2 <- SAV_plot_MOVE_2 + ggtitle("With MOVE()")
SAV_plot_MOVE_2
ggsave(file="output16 - FP&SAV - with_wind - with_MOVE - constant NtoP - SAV only.pdf",SAV_plot_MOVE_2, height=11,width=8)
...
FP_plotnoMOVE_2 <- FP_plotnoMOVE_2 + ylab(expression(paste("Annual avg. FP cover excl. 1st 3 yr")))
...
FP_plotnoMOVE_2 <- FP_plotnoMOVE_2 + ggtitle("Without MOVE()")
FP_plotnoMOVE_2
ggsave(file="output16 - FP&SAV - with_wind - without_MOVE - constant NtoP - FP only.pdf",FP_plotnoMOVE_2, height=11,width=8)
...
SAV_plotnoMOVE_2 <- SAV_plotnoMOVE_2 + ylab(expression(paste("Annual avg. SAV cover excl. 1st 3 yr")))
...
SAV_plotnoMOVE_2 <- SAV_plotnoMOVE_2 + ggtitle("Without MOVE()")
SAV_plotnoMOVE_2
ggsave(file="output16 - FP&SAV - with_wind - without_MOVE - constant NtoP - SAV only.pdf",SAV_plotnoMOVE_2, height=11,width=8)
