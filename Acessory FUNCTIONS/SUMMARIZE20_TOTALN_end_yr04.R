...
#############################################
# Categorize "state_score04" into "state"     #
# Discrete categories                       #
# if > 50/sqrt(2) "FP_state"                #   
# if < -50/sqrt(2) "SAV_state"              #
# if -50/sqrt(2) < state_score04 < 50/sqrt(2) #
# then "mixed"                              #    
#############################################
data$state[data$state_score04 > 50/sqrt(2)] <- "FP_state"
data$state[data$state_score04 < -50/sqrt(2)] <- "SAV_state"
data$state[-50/sqrt(2) < data$state_score04 & data$state_score04 < 50/sqrt(2)] <- "mixed"
...
# Size 0.04 ha #
################
SAV_FP_plot <- ggplot(data_A1_0x04, aes(x=TOTALN_end_yr04,y=state_score04))
...
SAV_FP_plot <- SAV_FP_plot + scale_x_log10()
SAV_FP_plot


ggsave(file="wind & shape & size - A1 - 0x04ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

################
# Scenario A1  #
# Size 1 ha    #
################
SAV_FP_plot <- ggplot(data_A1_1, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
SAV_FP_plot <- SAV_FP_plot + geom_point(alpha=0.2,size=3)                                      
SAV_FP_plot <- SAV_FP_plot + facet_grid(wind_direction ~ shape)
SAV_FP_plot <- SAV_FP_plot + xlab("Total N (mg/L)")
...
ggsave(file="wind & shape & size - A1 - 1ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

################
# Scenario A1  #
# Size 2.25 ha #
################
SAV_FP_plot <- ggplot(data_A1_2x25, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
SAV_FP_plot <- SAV_FP_plot + geom_point(alpha=0.2,size=3)                                      
SAV_FP_plot <- SAV_FP_plot + facet_grid(wind_direction ~ shape)
SAV_FP_plot <- SAV_FP_plot + xlab("Total N (mg/L)")
...
ggsave(file="wind & shape & size - A1 - 2x25ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

################
# Scenario A1  #
# Size 6.25 ha #
################
SAV_FP_plot <- ggplot(data_A1_6x25, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
SAV_FP_plot <- SAV_FP_plot + geom_point(alpha=0.2,size=3)                                      
SAV_FP_plot <- SAV_FP_plot + facet_grid(wind_direction ~ shape)
SAV_FP_plot <- SAV_FP_plot + xlab("Total N (mg/L)")
...
ggsave(file="wind & shape & size - A1 - 6x25ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

################
# Scenario A1  #
# Size 9 ha    #
################
SAV_FP_plot <- ggplot(data_A1_9, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
SAV_FP_plot <- SAV_FP_plot + geom_point(alpha=0.2,size=3)                                      
SAV_FP_plot <- SAV_FP_plot + facet_grid(wind_direction ~ shape)
SAV_FP_plot <- SAV_FP_plot + xlab("Total N (mg/L)")
...
ggsave(file="wind & shape & size - A1 - 9ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

# remove  title
SAV_FP_plot <- SAV_FP_plot + ggtitle(NULL)
SAV_FP_plot

ggsave(file="wind &  & size - A1 - 9ha - no_title - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)
...
SAV_FP_plot <- SAV_FP_plot + scale_x_continuous(breaks=c(1,3,5,7,9))
SAV_FP_plot
ggsave(file="wind & shape & size - A1 - 9ha - no_title - with_colour - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)
...
# Size 0.04 ha #
################
SAV_FP_plot <- ggplot(data_A2_0x04, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
...
ggsave(file="wind & shape & size - A2 - 0x04ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

################
# Scenario A2  #
# Size 1 ha    #
################
SAV_FP_plot <- ggplot(data_A2_1, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
SAV_FP_plot <- SAV_FP_plot + geom_point(alpha=0.2,size=3)                                      
SAV_FP_plot <- SAV_FP_plot + facet_grid(wind_direction ~ shape)
SAV_FP_plot <- SAV_FP_plot + xlab("Total N (mg/L)")
...
ggsave(file="wind & shape & size - A2 - 1ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

################
# Scenario A2  #
# Size 2.25 ha #
################
SAV_FP_plot <- ggplot(data_A2_2x25, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
SAV_FP_plot <- SAV_FP_plot + geom_point(alpha=0.2,size=3)                                      
SAV_FP_plot <- SAV_FP_plot + xlab("Total N (mg/L)")
SAV_FP_plot <- SAV_FP_plot + facet_grid(wind_direction ~ shape)
...
ggsave(file="wind & shape & size - A2 - 2x25ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

################
# Scenario A2  #
# Size 6.25 ha #
################
SAV_FP_plot <- ggplot(data_A2_6x25, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
SAV_FP_plot <- SAV_FP_plot + geom_point(alpha=0.2,size=3)                                      
SAV_FP_plot <- SAV_FP_plot + facet_grid(wind_direction ~ shape)
SAV_FP_plot <- SAV_FP_plot + xlab("Total N (mg/L)")
...
ggsave(file="wind & shape & size - A2 - 6x25ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

################
# Scenario A2  #
# Size 9 ha    #
################
SAV_FP_plot <- ggplot(data_A2_9, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
SAV_FP_plot <- SAV_FP_plot + geom_point(alpha=0.2,size=3)                                   
SAV_FP_plot <- SAV_FP_plot + facet_grid(wind_direction ~ shape)
SAV_FP_plot <- SAV_FP_plot + xlab("Total N (mg/L)")
...
ggsave(file="wind & shape & size - A2 - 9ha - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

# remove  title
SAV_FP_plot <- SAV_FP_plot + ggtitle(NULL)
SAV_FP_plot

ggsave(file="wind & shape & size - A2 - 9ha - no_title - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)
...
SAV_FP_plot <- SAV_FP_plot + scale_x_continuous(breaks=c(1,3,5,7,9))
SAV_FP_plot
ggsave(file="wind & shape & size - A2 - 9ha - no_title - with_colour - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)
...
SAV_FP_plot <- ggplot(data_temp, aes(x=TOTALN_end_yr04,y=state_score04))
SAV_FP_plot <- SAV_FP_plot + scale_colour_grey()
SAV_FP_plot <- SAV_FP_plot + geom_point(alpha=0.2,size=3)
...
ggsave(file="wind & shape & size - A1 - rectangle - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

# remove  title
SAV_FP_plot <- SAV_FP_plot + ggtitle(NULL)
SAV_FP_plot

ggsave(file="wind & shape & size - A1 - rectangle - no_title - TOTALN_end_yr04.jpg - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)
...
SAV_FP_plot <- SAV_FP_plot + scale_x_continuous(breaks=c(1,3,5,7,9))
SAV_FP_plot
ggsave(file="wind & shape & size - A1 - rectangle - no_title - with_colour - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=13)
...
ggsave(file="wind & shape & size - A2 - rectangle - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)

# remove  title
SAV_FP_plot <- SAV_FP_plot + ggtitle(NULL)
SAV_FP_plot

ggsave(file="wind & shape & size - A2 - rectangle - no_title - TOTALN_end_yr04.jpg - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=12)
...
SAV_FP_plot <- SAV_FP_plot + scale_x_log10()
SAV_FP_plot
ggsave(file="wind & shape & size - A2 - rectangle - no_title - with_colour - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=13)
...
ggsave(file="wind & shape & size - A2 - rectangle - all - TOTALN_end_yr04.jpg",SAV_FP_plot, height=4,width=12)
...
ggsave(file="wind & shape & size - A2 - rectangle - up - TOTALN_end_yr04.jpg",SAV_FP_plot, height=4,width=12)
...
SAV_FP_plot <- SAV_FP_plot + scale_x_continuous(breaks=c(1,3,5,7,9))
SAV_FP_plot
ggsave(file="wind & shape & size - A1 - 9ha - no_title - with_colour - TOTALN_end_yr04.jpg",SAV_FP_plot, height=8,width=13)
...
ggsave(file="wind & shape & size - A2 - 9ha - all - TOTALN_end_yr04.jpg",SAV_FP_plot, height=4,width=12)
...
ggsave(file="wind & shape & size - A2 - 9ha - up - TOTALN_end_yr04.jpg",SAV_FP_plot, height=4,width=12)
...
ggsave(file="wind & shape & size - A1 - 0x04ha - rectangle - up - TOTALN_end_yr04.jpg",SAV_FP_plot, height=6,width=6)
