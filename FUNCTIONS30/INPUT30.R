...
INPUT30 <- function(x){  
  assign("height1", parameters$height1[simulnumb], pos = 1)  # overall height of the grid
  assign("width1", parameters$width1[simulnumb], pos = 1)   # overall width of the grid
  assign("height2", parameters$height2[simulnumb], pos = 1)  # height of land chunk(s) 
  assign("width2", parameters$width2[simulnumb], pos = 1)   # width of land chunk(s) 
  assign("shape", parameters$shape[simulnumb], pos = 1)   # shape of the water body   
  assign("area", parameters$area[simulnumb], pos = 1)   # area of the water body  
  ...
  # uptake parameters - SAV
  assign("cVNUptMax_SAV", parameters$cVNUptMax_SAV[simulnumb], pos = 1)   
  assign("cNDMax_SAV", parameters$cNDMax_SAV[simulnumb], pos = 1) 
  assign("cNDMin_SAV", parameters$cNDMin_SAV[simulnumb], pos = 1) 
  assign("cAffNUpt_SAV", parameters$cAffNUpt_SAV[simulnumb], pos = 1) 
  assign("rNDnew_SAV", parameters$rNDnew_SAV[simulnumb], pos = 1) 
  assign("rNDold_SAV", parameters$rNDold_SAV[simulnumb], pos = 1) 
  
  # uptake parameters - FP
  assign("cVNUptMax_FP", parameters$cVNUptMax_FP[simulnumb], pos = 1)   
  assign("cNDMax_FP", parameters$cNDMax_FP[simulnumb], pos = 1) 
  assign("cNDMin_FP", parameters$cNDMin_FP[simulnumb], pos = 1) 
  assign("cAffNUpt_FP", parameters$cAffNUpt_FP[simulnumb], pos = 1) 
  assign("rNDnew_FP", parameters$rNDnew_FP[simulnumb], pos = 1) 
  assign("rNDold_FP", parameters$rNDold_FP[simulnumb], pos = 1) 
  ...
  assign("mix_freq", parameters$mix_freq[simulnumb], pos = 1)    # numb. of days btwn. complete mixing of the lake 
}