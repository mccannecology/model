...
INPUT28 <- function(x){  
  ...
  # Half saturation of biomass - not necessary for Scheffer version of this model
  ...
  # Half saturation of phosphorus - not necessary for Scheffer version of this model
